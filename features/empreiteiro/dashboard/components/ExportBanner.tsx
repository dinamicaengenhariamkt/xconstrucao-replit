...
import { RelatorioDashboardModal } from './RelatorioDashboardModal';
import type {
  DashboardStats,
  FinancialOverview,
  Activity,
...
export function ExportBanner({ stats, financial, activities, efficiency }: ExportBannerProps) {
