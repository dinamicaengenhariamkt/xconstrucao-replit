  ...
  return (
    <div className="flex flex-col gap-4">
      <AccordionSection title="Sobre o Projeto" icon="info" defaultOpen={true}>
        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed mb-4">{obra.descricao}</p>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4">
            <p className="text-xs text-gray-400 uppercase tracking-wider">Área Total</p>
            <p className="text-base font-bold text-gray-900 dark:text-white mt-1">{obra.areaTotal}</p>
          </div>
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4">
            <p className="text-xs text-gray-400 uppercase tracking-wider">Tipo</p>
            <p className="text-base font-bold text-gray-900 dark:text-white mt-1">{obra.tipoObra}</p>
          </div>
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4">
            <p className="text-xs text-gray-400 uppercase tracking-wider">Localização</p>
            <p className="text-base font-bold text-gray-900 dark:text-white mt-1">{obra.localizacao.bairro}</p>
      ...
      <AccordionSection title="Etapas do Projeto" icon="checklist">
        <div className="flex flex-col gap-3">
          {obra.etapas.map((etapa, index) => (
            <div key={etapa.id} className="flex items-start gap-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
