...
export const mockObraDetalhe: Record<string, ObraDetalhe> = {
  'nova-1': {
    ...
    localizacao: { cidade: 'Bertioga', estado: 'SP', bairro: 'Riviera de São Lourenço' },
    etapas: [
      { id: 'e1', nome: 'Fundação e Estrutura', descricao: 'Terraplanagem, fundação e estrutura de concreto', prazo: '3 meses', status: 'pendente' },
      { id: 'e2', nome: 'Alvenaria e Cobertura', descricao: 'Levantamento de paredes, laje e telhado', prazo: '2 meses', status: 'pendente' },
      { id: 'e3', nome: 'Instalações', descricao: 'Elétrica, hidráulica e gás', prazo: '2 meses', status: 'pendente' },
      { id: 'e4', nome: 'Acabamentos', descricao: 'Revestimentos, pisos, pintura e esquadrias', prazo: '3 meses', status: 'pendente' },
      { id: 'e5', nome: 'Paisagismo e Piscina', descricao: 'Jardim, deck, piscina e área externa', prazo: '2 meses', status: 'pendente' },
    ],
    documentos: [
