...
function buildKPI(medicoes: MedicaoEmpreiteiro[]): PagamentosEmpreiteiroKPI {
...
export const mockPagamentosKPI: PagamentosEmpreiteiroKPI = buildKPI(mockMedicoesEmpreiteiro);
