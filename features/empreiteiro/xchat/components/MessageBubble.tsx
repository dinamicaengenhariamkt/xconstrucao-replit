...
function formatTimestamp(raw: string): string {
  // If already formatted (HH:MM or relative), return as-is
            ...
            <div className="px-3 py-2.5">
              ...
              <div className="mt-2">
                <div className="flex items-center justify-between mb-1">
                  ...
                  >
                    {STATUS_LABEL[message.attachment.obraStatus] ?? message.attachment.obraStatus}
                  </span>
                  <span
                    className={cn(
              ...
              <Link
                href={`/empreiteiro/minhas-obras/${message.attachment.obraId}`}
                className={cn(
