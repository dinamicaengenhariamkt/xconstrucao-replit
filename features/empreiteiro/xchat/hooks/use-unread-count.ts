...
async function getUnreadCount(): Promise<number> {
  const res = await fetch('/api/empreiteiro/chat/unread-count');
...
/**
 * Total agregado de mensagens não-lidas do empreiteiro. Fica montado na sidebar
 ...
 */
export function useEmpreiteiroUnreadCount(): UseQueryResult<number, Error> {
  return useQuery({
    queryKey: ['empreiteiro', 'chat', 'unread-count'],
