...
- 2026-07-19 (Task #207): Erro HTTP 402 `LIMITE_PLANO` em `POST /api/obras` agora exibe `PlanoUpsellDialog` (componente compartilhado em `features/planos/ui/`) em vez de toast genérico — CTA leva para `/contratante/planos`.
