module.exports = [
"[project]/server/bootstrap-onboarding.ts [instrumentation] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function bootstrapOnboardingSchema() {
    try {
        // 1) Cria a coluna com DEFAULT true → linhas legadas nascem concluídas
        //    (sem rewrite). Se a coluna já existe, este passo é no-op.
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`ALTER TABLE users ADD COLUMN IF NOT EXISTS onboarding_concluido BOOLEAN NOT NULL DEFAULT true`);
        // 2) A partir de agora, novos cadastros nascem `false` (vão para o wizard).
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`ALTER TABLE users ALTER COLUMN onboarding_concluido SET DEFAULT false`);
    } catch (err) {
...
//# sourceMappingURL=_1whmde0._.js.map