module.exports = [
"[project]/server/bootstrap-planos.ts [instrumentation] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {
__turbopack_context__.s([
    "bootstrapPlanosSchema",
    ()=>bootstrapPlanosSchema
]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$lib$2f$plans$2d$catalog$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/shared/lib/plans-catalog.ts [instrumentation] (ecmascript)");
...
;
;
async function bootstrapPlanosSchema() {
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`DO $$ BEGIN CREATE TYPE plano_persona AS ENUM ('contratante','empreiteiro','ambos'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;`);
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`DO $$ BEGIN CREATE TYPE assinatura_status AS ENUM ('ativa','cancelada','inadimplente','expirada'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;`);
        // Migração idempotente: adiciona 'pendente_reativacao' ao enum se ainda não existir.
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`DO $$ BEGIN ALTER TYPE assinatura_status ADD VALUE IF NOT EXISTS 'pendente_reativacao'; EXCEPTION WHEN others THEN NULL; END $$;`);
    ...
    `);
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`CREATE INDEX IF NOT EXISTS idx_assinaturas_user ON assinaturas(user_id)`);
        // No máximo uma assinatura ATIVA por usuário.
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`CREATE UNIQUE INDEX IF NOT EXISTS uq_assinaturas_user_ativa ON assinaturas(user_id) WHERE status = 'ativa'`);
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`
    ...
    `);
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`CREATE UNIQUE INDEX IF NOT EXISTS uq_assinatura_eventos_gateway ON assinatura_eventos(gateway_event_id) WHERE gateway_event_id IS NOT NULL`);
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`ALTER TABLE assinaturas ADD COLUMN IF NOT EXISTS gateway_retry_count INTEGER NOT NULL DEFAULT 0`);
        // Migração idempotente: adiciona pendente_reativacao_at se ainda não existir.
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`ALTER TABLE assinaturas ADD COLUMN IF NOT EXISTS pendente_reativacao_at TIMESTAMP`);
        ...
        for (const persona of personas){
            for (const tier of tiers){
                const c = __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$lib$2f$plans$2d$catalog$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["PLANS_CATALOG"][persona][tier];
                await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`
          ...
          VALUES (
            ...
            ${JSON.stringify(c.limites)}::jsonb, ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"].raw(`ARRAY[${c.features.map((f)=>`'${f.replace(/'/g, "''")}'`).join(",")}]::text[]`)}, TRUE
          )
...
"[project]/shared/lib/plans-catalog.ts [instrumentation] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const PLANS_CATALOG = {
    ...
    contratante: {
        free: {
            ...
            limites: {
                obrasAbertas: 1,
                empreiteirosContratados: 3,
                contratosAtivos: 1,
                propostasRecebidas: 5
            }
        },
        pro: {
            nome: 'Plano Profissional',
            ...
            limites: {
                obrasAbertas: 5,
                empreiteirosContratados: 10,
                contratosAtivos: 5,
                propostasRecebidas: 50
            }
        },
        enterprise: {
            nome: 'Plano Empresarial',
            ...
            limites: {
                obrasAbertas: 9999,
                empreiteirosContratados: 9999,
                contratosAtivos: 9999,
                propostasRecebidas: 9999
            }
        }
    }
};
function getPlanCatalog(persona, tier) {
    return PLANS_CATALOG[persona][tier];
}
}),
];

//# sourceMappingURL=_1xkqcm1._.js.map