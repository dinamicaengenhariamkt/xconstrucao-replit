module.exports = [
"[project]/server/bootstrap-faq.ts [instrumentation] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const FAQ_SEED = [
    ...
    // ── Anunciante (J53) — pré-criadas, editáveis pelo admin ──────────────────
    {
        ...
        answer: 'Acesse "Novo pedido de anúncio" no seu painel, escolha um ou mais locais (zonas) onde o anúncio vai aparecer, monte o criativo com a pré-visualização ao vivo e envie o pedido. Ele passa por uma moderação antes de entrar no ar.',
        category: "anuncios",
        visao: "anunciante",
        ordem: 1,
        ativo: true,
    ...
    },
    {
        ...
        answer: "Todo anúncio passa por uma moderação para garantir que o criativo está adequado e dentro das regras da plataforma. Assim que aprovado, você é avisado e, quando a cobrança está ativa, recebe o link para pagamento. O anúncio entra no ar após a confirmação.",
        category: "anuncios",
        visao: "anunciante",
        ordem: 3,
        ativo: true,
    ...
    },
    {
        ...
        answer: 'Depois que o pedido é aprovado, aparece o botão "Pagar" no seu pedido. Você informa um CPF ou CNPJ e é levado ao checkout seguro. Assim que o pagamento é confirmado, o anúncio é publicado automaticamente no período escolhido. O anúncio só passa a veicular após o pagamento confirmado.',
        category: "anuncios",
        visao: "anunciante",
        ordem: 4,
        ativo: true,
    ...
    },
    {
        ...
        answer: 'Sim. Em "Meus Anúncios" você acompanha o status de cada pedido e dos anúncios publicados. Anúncios ativos podem ser pausados e reativados — exceto anúncios já pagos, que veiculam do início ao fim do período contratado.',
        category: "anuncios",
        visao: "anunciante",
        ordem: 5,
        ativo: true,
...
async function bootstrapFaqSchema() {
    await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`DO $$ BEGIN CREATE TYPE faq_visao AS ENUM ('contratante','empreiteiro','ambos'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;`);
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`ALTER TYPE faq_visao ADD VALUE IF NOT EXISTS 'anunciante'`);
    ...
    CREATE TABLE IF NOT EXISTS faq (
      ...
      visao faq_visao NOT NULL DEFAULT 'ambos',
  ...
  `);
    await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`CREATE INDEX IF NOT EXISTS idx_faq_categoria_ordem ON faq(category, ordem)`);
    // Seed idempotente: re-execuções não duplicam nem sobrescrevem edições do admin.
    for (const item of FAQ_SEED){
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`
      INSERT INTO faq (id, question, answer, category, visao, ordem, ativo, criado_em, atualizado_em)
      VALUES (
        ${item.id}, ${item.question}, ${item.answer}, ${item.category},
        ${item.visao}::faq_visao, ${item.ordem}, ${item.ativo},
        ${item.criadoEm}::timestamp, ${item.atualizadoEm}::timestamp
      )
...
//# sourceMappingURL=_0ukyuz3._.js.map