...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$schemas$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/auth/schemas/index.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$admin$2f$platform$2d$settings$2f$server$2f$settings$2d$reader$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/admin/platform-settings/server/settings-reader.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$api$2f$anti$2d$bot$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/auth/api/anti-bot.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$admin$2f$platform$2d$settings$2f$server$2f$settings$2d$reader$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
...
[__TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$api$2f$auth$2d$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$api$2f$auth$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$admin$2f$platform$2d$settings$2f$server$2f$settings$2d$reader$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$api$2f$auth$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
function jsonNoStore(payload, status) {
    const response = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(payload, {
        status
    });
...
async function POST(request) {
    const ip = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$api$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getClientIp"])(request);
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$api$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isRateLimited"])(`register:${ip}`, 5, 60 * 60 * 1000)) {
        return jsonNoStore({
    ...
    try {
        ...
        const antiBot = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$api$2f$anti$2d$bot$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateAntiBot"])(body);
        if (!antiBot.ok) {
            return jsonNoStore({
                message: GENERIC_BAD
            }, 400);
        }
        const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$schemas$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerSchema"].safeParse(body);
        if (!parsed.success) {
            return jsonNoStore({
        ...
        if ((role === "contratante" || role === "empreiteiro") && !await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$admin$2f$platform$2d$settings$2f$server$2f$settings$2d$reader$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isPerfilHabilitado"])(role)) {
            return jsonNoStore({
                message: role === "empreiteiro" ? "O cadastro de empreiteiros está temporariamente indisponível." : "O cadastro de contratantes está temporariamente indisponível."
            }, 403);
        }
        ...
        const minPolicy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$schemas$2f$password$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["evaluatePasswordPolicy"])(password, {
            email,
            name,
            username,
            minLength: await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$admin$2f$platform$2d$settings$2f$server$2f$settings$2d$reader$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSenhaMinima"])()
        });
        if (!minPolicy.valid) {
            return jsonNoStore({
                message: minPolicy.message ?? "Senha inválida."
            }, 400);
        }
        const existingEmail = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$api$2f$auth$2d$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserByEmail"])(email);
        if (existingEmail) {
            return jsonNoStore({
                message: "Email já cadastrado"
            }, 409);
        }
        const existingUsername = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$api$2f$auth$2d$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserByUsername"])(username);
        if (existingUsername) {
            return jsonNoStore({
                message: "Nome de usuário já cadastrado"
            }, 409);
        }
        const hashed = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$api$2f$auth$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(password);
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$api$2f$auth$2d$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createUserWithProfile"])({
            name,
            email,
            username,
            password: hashed,
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].insert(__TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userConsents"]).values([
                {
                    userId: user.id,
                    documento: "termos",
            ...
            void (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logError"])("error", "Failed to persist consent records", {
                stack: consentError?.stack,
                route: "/api/auth/register"
            });
            try {
                const { users } = await __turbopack_context__.A("[project]/shared/db/schema.ts [app-route] (ecmascript, async loader)");
                const { eq } = await __turbopack_context__.A("[project]/node_modules/drizzle-orm/index.js [app-route] (ecmascript, async loader)");
                await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].delete(users).where(eq(users.id, user.id));
            } catch (rollbackError) {
                void (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logError"])("error", "Failed to rollback user after consent failure", {
        ...
        const verificationToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$api$2f$auth$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createEmailVerificationToken"])(user.id, user.email);
        const baseUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$api$2f$auth$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getBaseUrl"])(request);
        const verificationUrl = `${baseUrl}/api/auth/verify-email?token=${verificationToken}`;
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendVerificationEmail"])(user.email, verificationUrl, user.name);
        } catch (emailError) {
            void (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logError"])("warn", "Failed to send verification email", {
        ...
        if (cpfCnpj) {
            const { provisionarCustomerAsaas } = await __turbopack_context__.A("[project]/features/marketplace/customer-service.ts [app-route] (ecmascript, async loader)");
        ...
        void (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logError"])("error", "Erro no registro", {
            stack: error?.stack,
            route: "/api/auth/register"
        });
        return jsonNoStore({
...
"[project]/features/admin/platform-settings/server/settings-reader.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function loadAll() {
    const rows = await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].select({
        chave: __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["platformSettings"].chave,
        valor: __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["platformSettings"].valor
    }).from(__TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["platformSettings"]);
 ...
 */ async function getRawSetting(grupo, chave) {
    try {
        const [row] = await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].select({
            valor: __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["platformSettings"].valor
        }).from(__TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["platformSettings"]).where((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eq"])(__TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["platformSettings"].chave, grupo));
...
"[project]/features/auth/api/anti-bot.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/features/auth/schemas/index.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$schemas$2f$password$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/auth/schemas/password.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$lib$2f$masks$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/shared/lib/masks.ts [app-route] (ecmascript)");
;
;
;
const emailField = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, "Email é obrigatório").transform((s)=>s.trim().toLowerCase()).pipe(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().email("Email inválido"));
const loginSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    email: emailField,
    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, "Senha obrigatória")
});
const registerSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    name: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(2, "Nome deve ter no mínimo 2 caracteres"),
    email: emailField,
    username: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().toLowerCase().min(3, "Usuário deve ter no mínimo 3 caracteres").regex(/^[a-z0-9_.]+$/, "Use apenas letras, números, ponto ou underline"),
    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(8, "A senha deve ter no mínimo 8 caracteres"),
    ...
    cpfCnpj: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional().transform((v)=>v ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$lib$2f$masks$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["unformatCpfCnpj"])(v) : v),
    ...
    const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$schemas$2f$password$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["evaluatePasswordPolicy"])(data.password, {
        email: data.email,
        name: data.name,
    ...
    if (data.cpfCnpj && (data.role === "contratante" || data.role === "empreiteiro")) {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$lib$2f$masks$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isCpfCnpjValid"])(data.cpfCnpj)) {
            ctx.addIssue({
                code: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].ZodIssueCode.custom,
                path: [
                    "cpfCnpj"
...
const resetPasswordSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(8, "A senha deve ter no mínimo 8 caracteres"),
    confirmPassword: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, "Confirmação obrigatória")
}).superRefine((data, ctx)=>{
...
"[project]/shared/lib/masks.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function lookupCep(cep, signal) {
...
function unformatCpfCnpj(v) {
    return (v || "").replace(/\D/g, "").slice(0, 14);
}
function isCpfCnpjValid(v) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0-4een1._.js.map