module.exports = [
"[project]/server/bootstrap-marketplace-split.ts [instrumentation] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {
__turbopack_context__.s([
    "bootstrapMarketplaceSplitSchema",
    ()=>bootstrapMarketplaceSplitSchema
]);
...
;
;
async function bootstrapMarketplaceSplitSchema() {
    try {
        // Colunas novas em users (papel pagador/recebedor + customer Asaas proativo).
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`ALTER TABLE users ADD COLUMN IF NOT EXISTS cpf_cnpj TEXT`);
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`ALTER TABLE users ADD COLUMN IF NOT EXISTS asaas_customer_id TEXT`);
        // Enums (idempotentes via bloco DO com EXCEPTION duplicate_object).
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`DO $$ BEGIN CREATE TYPE asaas_subconta_status AS ENUM ('pendente','aguardando_kyc','aprovada','rejeitada'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;`);
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`DO $$ BEGIN CREATE TYPE split_pagamento_status AS ENUM ('pendente','confirmado','repassado','falhou','estornado'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;`);
    ...
    `);
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`CREATE UNIQUE INDEX IF NOT EXISTS uq_asaas_subcontas_user ON asaas_subcontas(user_id)`);
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`CREATE INDEX IF NOT EXISTS idx_asaas_subcontas_account ON asaas_subcontas(asaas_account_id)`);
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`CREATE INDEX IF NOT EXISTS idx_asaas_subcontas_wallet ON asaas_subcontas(wallet_id)`);
    ...
    `);
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`ALTER TABLE pagamentos_split ADD COLUMN IF NOT EXISTS invoice_url TEXT`);
        // Idempotência do webhook: um registro por asaas_payment_id (quando presente).
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`CREATE UNIQUE INDEX IF NOT EXISTS uq_pagamentos_split_asaas_payment ON pagamentos_split(asaas_payment_id) WHERE asaas_payment_id IS NOT NULL`);
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`CREATE INDEX IF NOT EXISTS idx_pagamentos_split_obra_status ON pagamentos_split(obra_id, status)`);
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`CREATE INDEX IF NOT EXISTS idx_pagamentos_split_financeiro ON pagamentos_split(financeiro_id)`);
        // J49 — histórico local de saques (transferências da subconta para o banco).
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`DO $$ BEGIN CREATE TYPE saque_status AS ENUM ('pendente','concluido','falhou'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;`);
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`
    ...
    `);
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`CREATE INDEX IF NOT EXISTS idx_saques_user ON saques(user_id)`);
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`CREATE INDEX IF NOT EXISTS idx_saques_transfer ON saques(asaas_transfer_id)`);
        // Falha cedo se algum CREATE/ALTER silenciosamente não aplicar (defesa Neon).
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$lib$2f$schema$2d$health$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["assertColumns"])("users", [
            "cpf_cnpj",
            "asaas_customer_id"
        ]);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$lib$2f$schema$2d$health$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["assertColumns"])("asaas_subcontas", [
            "user_id",
            "wallet_id",
            "asaas_api_key_enc",
            "onboarding_status"
        ]);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$lib$2f$schema$2d$health$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["assertColumns"])("pagamentos_split", [
            "asaas_payment_id",
            "obra_id",
            "status",
            "valor_empreiteiro"
        ]);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$lib$2f$schema$2d$health$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["assertColumns"])("saques", [
            "user_id",
            "valor",
            "status",
            "asaas_transfer_id"
...
//# sourceMappingURL=_1hm6s_6._.js.map