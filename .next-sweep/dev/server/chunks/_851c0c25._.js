...
"[project]/server/bootstrap-2fa.ts [instrumentation] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function bootstrap2faSchema() {
    try {
    ...
    `);
        await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`CREATE INDEX IF NOT EXISTS idx_user_totp_enabled ON user_totp(user_id) WHERE enabled = TRUE`);
...
//# sourceMappingURL=_851c0c25._.js.map