...
"[project]/server/bootstrap-empreiteiras-zona.ts [instrumentation] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

__turbopack_context__.s([
    "bootstrapEmpreiteirasZona",
    ()=>bootstrapEmpreiteirasZona
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/drizzle-orm/sql/sql.js [instrumentation] (ecmascript)");
...
;
;
async function bootstrapEmpreiteirasZona() {
    const cols = [
        {
            name: "zona_atuacao_ufs",
            ddl: "zona_atuacao_ufs text[] NOT NULL DEFAULT ARRAY[]::text[]"
        },
        {
            name: "zona_atuacao_cidades",
            ddl: "zona_atuacao_cidades text[] NOT NULL DEFAULT ARRAY[]::text[]"
        }
    ];
    for (const c of cols){
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"].raw(`ALTER TABLE empreiteiras ADD COLUMN IF NOT EXISTS ${c.ddl};`));
        } catch (err) {
...
//# sourceMappingURL=_a3be6324._.js.map