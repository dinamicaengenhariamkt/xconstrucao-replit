...
"[project]/features/financeiro/snapshot-kpis-job.ts [instrumentation] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function snapshotKpisJob() {
    const periodo = new Date().toISOString().slice(0, 10); // YYYY-MM-DD
    try {
        const [row] = await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`
      SELECT
    ...
    `).then((r)=>Array.isArray(r?.rows) ? r.rows : r);
        const metricas = [
            {
                metrica: "usuariosAtivos",
                valor: String(row?.usuarios_ativos ?? 0)
            },
            {
                metrica: "volumeContratado",
                valor: String(row?.volume_contratado ?? 0)
            },
            {
                metrica: "taxasPlataforma",
                valor: String(row?.taxas_plataforma ?? 0)
            }
        ];
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].insert(__TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$schema$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["kpiSnapshots"]).values(metricas.map((m)=>({
                metrica: m.metrica,
                valor: m.valor,
                periodo
            }))).onConflictDoNothing({
            target: [
                __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$schema$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["kpiSnapshots"].metrica,
                __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$schema$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["kpiSnapshots"].periodo
            ]
        }).returning({
            id: __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$schema$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["kpiSnapshots"].id
        });
...
//# sourceMappingURL=_8cb2e729._.js.map