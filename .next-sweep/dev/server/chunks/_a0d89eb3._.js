...
"[project]/server/bootstrap-obras.ts [instrumentation] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

__turbopack_context__.s([
    "bootstrapObrasSchema",
    ()=>bootstrapObrasSchema
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/drizzle-orm/sql/sql.js [instrumentation] (ecmascript)");
...
;
;
async function bootstrapObrasSchema() {
    const enums = [
        {
            name: "obra_visibilidade",
            values: [
                "rascunho",
                "publicada",
                "pausada",
    ...
    for (const e of enums){
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"].raw(`DO $$
BEGIN
...
END$$;`));
    ...
    const obrasColumns = [
        {
            name: "visibilidade",
            ddl: "visibilidade obra_visibilidade NOT NULL DEFAULT 'rascunho'"
        },
        {
            name: "status_moderacao",
            ddl: "status_moderacao obra_status_moderacao NOT NULL DEFAULT 'pendente'"
        },
        {
            name: "motivo_moderacao",
            ddl: "motivo_moderacao TEXT"
        },
        {
            name: "moderado_em",
            ddl: "moderado_em TIMESTAMP"
        },
        {
            name: "moderado_por",
            ddl: "moderado_por VARCHAR REFERENCES users(id) ON DELETE SET NULL"
        },
        {
            name: "tipo",
            ddl: "tipo TEXT"
        ...
        {
            name: "lat",
            ddl: "lat NUMERIC(10,7)"
        },
        {
            name: "lng",
            ddl: "lng NUMERIC(10,7)"
        },
        {
            name: "modalidade",
            ddl: "modalidade obra_modalidade"
        },
        {
            name: "materiais_por",
            ddl: "materiais_por obra_materiais_por"
        },
        {
            name: "area_m2",
            ddl: "area_m2 NUMERIC(10,2)"
        },
        {
            name: "padrao_acabamento",
            ddl: "padrao_acabamento TEXT"
        },
        {
            name: "acessibilidade_obs",
            ddl: "acessibilidade_obs TEXT"
        },
        {
            name: "created_at",
            ddl: "created_at TIMESTAMP DEFAULT NOW()"
        },
        {
            name: "updated_at",
            ddl: "updated_at TIMESTAMP DEFAULT NOW()"
        },
        // J25 — Obras em Destaque na Home (curadoria admin).
        {
            name: "destaque",
            ddl: "destaque BOOLEAN NOT NULL DEFAULT false"
        },
        {
            name: "destaque_ordem",
            ddl: "destaque_ordem INTEGER"
        },
        // foto de capa "congelada" escolhida pelo admin (FK criada à parte abaixo).
        {
            name: "foto_capa_file_id",
            ddl: "foto_capa_file_id VARCHAR"
        }
    ];
    for (const col of obrasColumns){
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"].raw(`ALTER TABLE obras ADD COLUMN IF NOT EXISTS ${col.ddl};`));
        } catch (err) {
    ...
    try {
        ...
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`SELECT 1 AS ok FROM schema_migrations WHERE name = ${marker}`);
      ...
      `);
            await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"]`INSERT INTO schema_migrations(name) VALUES(${marker}) ON CONFLICT (name) DO NOTHING`);
    ...
    for (const idx of indexes){
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$db$2f$db$2e$ts__$5b$instrumentation$5d$__$28$ecmascript$29$__["db"].execute(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$sql$2e$js__$5b$instrumentation$5d$__$28$ecmascript$29$__["sql"].raw(idx.ddl));
        } catch (err) {
...
//# sourceMappingURL=_a0d89eb3._.js.map