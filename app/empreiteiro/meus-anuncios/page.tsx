...
/**
 * J23/D6 — "Meus Anúncios" embutido na visão de empreiteiro. Mesmo componente
 * compartilhado; empreiteiro anuncia sem sair da própria visão.
 */
export default function EmpreiteiroMeusAnunciosPage() {
  ...
  return (
    <div className="p-6 md:p-12 space-y-8 max-w-5xl">
      ...
      {criando ? (
        <MontadorPedido redirectTo="/empreiteiro/meus-anuncios" />
      ) : (
        <MeusAnunciosLista />
      )}
    </div>
